...
#define FACTOR8 ((double)1.0 / (double)(1 << 7))
#define FACTOR16 ((double)1.0 / (double)(1 << 15))
#define FACTOR32 ((double)1.0 / (double)(1UL << 31))
...
double get_sample(void *buf, size_t i, enum AVSampleFormat sample_fmt) {
        switch(sample_fmt) {
        case AV_SAMPLE_FMT_U8: return (double)(((uint8_t *)buf)[i] - 0x80) * FACTOR8;
        case AV_SAMPLE_FMT_S16: return (double)(((int16_t *)buf)[i]) * FACTOR16;
        case AV_SAMPLE_FMT_S32: return (double)(((int32_t *)buf)[i]) * FACTOR32;
        case AV_SAMPLE_FMT_FLT: return (double)(((float *)buf)[i]);
        case AV_SAMPLE_FMT_DBL: return (double)(((double *)buf)[i]);
        default: return 0.0;
        }
}
