...
std::string str ( SampleFormat format ) {
    ...
    switch ( format ) {
    case SampleFormat::SAMPLE_FMT_NONE:
        return "";
    ...
    case SampleFormat::SAMPLE_FMT_DBLP:
        _smp_fmt.append ( "dbl" );
        break;
    ...
    case SampleFormat::SAMPLE_FMT_FLTP:
        _smp_fmt.append ( "flt" );
        break;

    case SampleFormat::SAMPLE_FMT_NB:
        _smp_fmt.append ( "nb" );
        break;
    ...
    case SampleFormat::SAMPLE_FMT_S16P:
        _smp_fmt.append ( "s16" );
        break;
    ...
    case SampleFormat::SAMPLE_FMT_S32P:
        _smp_fmt.append ( "s32" );
        break;
    ...
    case SampleFormat::SAMPLE_FMT_U8P:
        _smp_fmt.append ( "u8" );
        break;
    }
