...
$DOCKER_EXEC "cd /repo && conan export . conan-cpp/latest && conan install avcpp/$TAG@conan-cpp/latest --build=missing && conan upload avcpp/$TAG@conan-cpp/latest --all -r=conan-cpp"
