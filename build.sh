...
$DOCKER_EXEC "cd /repo && conan export . conan-cpp/latest && conan install avcpp/$2@conan-cpp/latest --build=missing && conan upload avcpp/$2@conan-cpp/latest --all -r=conan-cpp"
